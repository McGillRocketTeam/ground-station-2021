...
analysis_parameters = {
    ...
    "grainDensity": (788.9, 50),  # Motor's grain density (kg/m^3)
    "grainOuterRadius": (0.039624, 0.375 / 1000),  # Motor's grain outer radius (m)
    "grainInitialInnerRadius": (
        0.0226949,
        0.375 / 1000,
    ),  # Motor's grain inner radius (m)
    "grainInitialHeight": (0.6096, 1 / 1000),  # Motor's grain height (m)
    ...
    "radius": (0.07874, 0.001),  # Rocket's radius (kg*m^2)
    ...
    "noseLength": (0.914, 0.001),  # Rocket's nose cone length (m)
    "noseDistanceToCM": (
        1.455155586,
        0.001,
    ),  # Axial distance between rocket's center of dry mass and nearest point in its nose cone (m)
    "finSpan": (0.127, 0.0005),  # Fin span (m)
    "finRootChord": (0.4318, 0.0005),  # Fin root chord (m)
    "finTipChord": (0.1143, 0.0005),  # Fin tip chord (m)
    "finDistanceToCM": (
        -1.3617956,
        0.001,
    ...
    "heading": (6, 2),  # Launch rail heading relative to north (degrees)
    "railLength": (6.0452, 0.0005),  # Launch rail length (m)
