...
launch_azimith_angle_in = 0     #from north to rocket
sigma_azimith_angle = 0
azimith_angle_perturbed = np.random.normal(launch_azimith_angle_in, sigma_azimith_angle, num_launches)
