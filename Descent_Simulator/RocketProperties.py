class RocketProperties:
    ...
    def __init__(self, main_deploy_altitude=305, apogee=3090, velocity_off_rail_mag=31.4, rocket_cx_area=0.01, drogue_cx_area= 0.29, main_cx_area=5.9, vertical_drag_coeff_drogue=1.3,
    vertical_drag_coeff_main=1.3, drogue_deploy_altitude=3090, transverse_drag_coeff_drogue=1.3, transverse_drag_coeff_main=1.3,
