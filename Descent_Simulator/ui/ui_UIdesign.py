...
################################################################################
## Form generated from reading UI file 'UIdesignmgqUWk.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(1001, 851)
        Dialog.setStyleSheet(u"background-color: rgb(74, 75, 72);")
        self.frame = QFrame(Dialog)
        self.frame.setObjectName(u"frame")
        self.frame.setGeometry(QRect(0, 0, 1000, 850))
        self.frame.setStyleSheet(u"background-color: rgb(54, 55, 56);")
        self.frame.setFrameShape(QFrame.StyledPanel)
        self.frame.setFrameShadow(QFrame.Raised)
        self.mrtLabel = QLabel(self.frame)
...
"font: 10pt \"Impact\";")
        ...
        self.launchButton = QPushButton(self.frame)
        self.launchButton.setObjectName(u"launchButton")
        self.launchButton.setGeometry(QRect(380, 570, 201, 91))
        font4 = QFont()
