class RocketProperties:
    ...
    vertical_drag_coeff_main, drogue_deploy_altitude_in, transverse_drag_coeff_drogue, transverse_drag_coeff_main,
    rocket_mass_in, drogue_deploys_bool, main_deploys_bool):
    ...
    # Situational parameters (i.e. whether or not the parachutes deploy)
        ...
        self.rocket_mass = rocket_mass_in
