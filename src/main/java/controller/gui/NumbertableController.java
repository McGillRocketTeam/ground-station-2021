...
//		setCurrentVelocityLabel(String.format("%.2f", data[DataIndex.VELOCITY_INDEX.getOrder()]));
//		setCurrentVelocityLabel(String.format("%.2f", data[DataIndex.ACCEL_X_INDEX.getOrder()]));
