...
public class tests {
	...
	public void testSaveTelemetryCSV() {
		...
		Assert.assertTrue(DataStorage.saveDataCSV(TEST_FORMATTED_DATES, DataStorage.TELEMETRY, TEST_FILE_TIME, good_telemetry));
		// should add something to check that the line written to the CSV file actually matches the stringed version of good_telemetry
